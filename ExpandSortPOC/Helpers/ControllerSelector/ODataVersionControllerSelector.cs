...
namespace ExpandSortPOC.Helpers.ControllerSelector
{
    /// <summary>
    ...
    {
        private readonly Dictionary<string, string> _routeVersionSuffixMapping = new Dictionary<string, string>();
        ...
        public override string GetControllerName(HttpRequestMessage request)
        {
            ...
            var routeName = ODataV3Helper.GetRouteName(request) ?? ODataV4Helper.GetRouteName(request);
